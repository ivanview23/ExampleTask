...
//    }
    public static void main(String[] args) {
        ...
        MyHashSet<MyClass> set = new MyHashSet<>();

        set.add(new MyClass("qqq"));
        set.add(new MyClass("eee"));
        set.add(new MyClass("fff"));
        set.add(new MyClass("ddd"));
        set.add(new MyClass("lll"));
        set.add(new MyClass("hhh"));
